...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "convenient", label: "Tiện lợi và thanh toán nhanh mượt (tích hợp sẵn trên app)" },
      { value: "split", label: "Thích cảm giác chia nhỏ khoản tiền và không bị \"xót ví\" khi trả một cục" },
      { value: "other", label: "Khác", allowCustom: true },
    ],
  },
  {
  ...
  },
  {
    ...
    maxSelect: 3,
    options: [
      { value: "baivietdai", label: "Bài viết dài và phân tích chuyên sâu về BNPL kèm hình ảnh trào phúng thị giác." },
      { value: "keogoi", label: "Bài đăng kêu gọi cộng đồng chia sẻ trải nghiệm chi tiêu cá nhân." },
      { value: "thaoluan", label: "Bài đăng mở không gian thảo luận và bình luận góp ý cùng cộng đồng." },
      { value: "hinhhaihuoc", label: "Hình ảnh hài hước và châm biếm về thói quen chi tiêu." },
      { value: "minigame", label: "Minigame hoặc câu chuyện dễ đọc và dễ theo dõi." },
    ],
  },
  {
    id: "p5_6",
    ...
    maxSelect: 3,
    options: [
      { value: "trend", label: "Video bắt trend và cập nhật xu hướng mới nhất." },
